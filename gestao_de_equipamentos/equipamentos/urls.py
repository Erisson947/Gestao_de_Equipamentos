...
urlpatterns = [    
    ...
    path('comentario/denunciar/<pk>/', views.denunciar_comentario, name='denunciar_comentario'),
    ...
    path('resposta/denunciar/<pk>/', views.denunciar_resposta, name='denunciar_resposta'),
